...
public class MealsUtil {
    public static void main(String[] args) {
        ...
        meals.addAll(DataInMemory.data.values());
        List<MealTo> mealsWithExcess = getFilteredWithExcess(meals, LocalTime.of(0, 0), LocalTime.of(23, 0), 2000);
    ...
    public static List<MealTo> getFilteredWithExcess(List<Meal> meals){
        return getFilteredWithExcess(meals,LocalTime.of(0, 0), LocalTime.of(23, 0), 2000);
    }
